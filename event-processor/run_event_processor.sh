...
printf "\n\n==================== Preparando projeto Event-Processor ====================\n\n"
...
if [ ! -f "pom.xml" ]; then
    echo "O arquivo pom.xml não foi encontrado no diretório event-processor. Certifique-se de que esteja no diretório correto."
    exit 1
fi

mvn clean package

docker build -t event-processor-1.0.0 .
...
NOME_CONTAINER="event-processor"
